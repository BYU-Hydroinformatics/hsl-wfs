...
$(document).ready(function() {
	...
	$("#method").change(function() {
		...
		$.ajax({
			url:"http://worldwater.byu.edu/interactive/sandbox/services/index.php/cuahsi/method_get_params/" + $(this).val(),
	...
	$("#btnGenerator").click(function(e) {
	    $.ajax({
           type: "POST",
           url: "http://worldwater.byu.edu/interactive/sandbox/services/index.php/cuahsi/generate_url/",
